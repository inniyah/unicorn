...
static void spr_read_ibat (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, IBAT[sprn & 1][(sprn - SPR_IBAT0U) / 2]));
}
...
static void spr_read_ibat_h (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, IBAT[sprn & 1][(sprn - SPR_IBAT4U) / 2]));
}
...
static void spr_write_ibatu (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_IBAT0U) / 2);
    gen_helper_store_ibatu(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
...
static void spr_write_ibatu_h (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, ((sprn - SPR_IBAT4U) / 2) + 4);
    gen_helper_store_ibatu(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_ibatl (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_IBAT0L) / 2);
    gen_helper_store_ibatl(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_ibatl_h (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, ((sprn - SPR_IBAT4L) / 2) + 4);
    gen_helper_store_ibatl(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_read_dbat (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, DBAT[sprn & 1][(sprn - SPR_DBAT0U) / 2]));
}
...
static void spr_read_dbat_h (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, DBAT[sprn & 1][((sprn - SPR_DBAT4U) / 2) + 4]));
}
...
static void spr_write_dbatu (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_DBAT0U) / 2);
    gen_helper_store_dbatu(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_dbatu_h (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, ((sprn - SPR_DBAT4U) / 2) + 4);
    gen_helper_store_dbatu(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_dbatl (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_DBAT0L) / 2);
    gen_helper_store_dbatl(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_dbatl_h (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, ((sprn - SPR_DBAT4L) / 2) + 4);
    gen_helper_store_dbatl(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_sdr1 (void *opaque, int sprn, int gprn)
{
    ...
    gen_helper_store_sdr1(ctx->uc->tcg_ctx, cpu_env, cpu_gpr[gprn]);
}
...
static void spr_read_hior (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, excp_prefix));
}
...
static void spr_write_hior (void *opaque, int sprn, int gprn)
{
    ...
    TCGv t0 = tcg_temp_new(ctx->uc->tcg_ctx);
    tcg_gen_andi_tl(ctx->uc->tcg_ctx, t0, cpu_gpr[gprn], 0x3FFFFF00000ULL);
...
static void spr_read_601_rtcl (void *opaque, int gprn, int sprn)
{
    ...
    gen_helper_load_601_rtcl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env);
}
...
static void spr_write_601_rtcu (void *opaque, int sprn, int gprn)
{
    ...
    gen_helper_store_601_rtcu(ctx->uc->tcg_ctx, cpu_env, cpu_gpr[gprn]);
}
...
static void spr_write_601_rtcl (void *opaque, int sprn, int gprn)
{
    ...
    gen_helper_store_601_rtcl(ctx->uc->tcg_ctx, cpu_env, cpu_gpr[gprn]);
}
...
static void spr_write_hid0_601 (void *opaque, int sprn, int gprn)
{
    ...
    gen_helper_store_hid0_601(ctx->uc->tcg_ctx, cpu_env, cpu_gpr[gprn]);
...
static void spr_write_601_ubatu (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_IBAT0U) / 2);
    gen_helper_store_601_batl(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
...
static void spr_write_601_ubatl (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, (sprn - SPR_IBAT0U) / 2);
    gen_helper_store_601_batu(ctx->uc->tcg_ctx, cpu_env, t0, cpu_gpr[gprn]);
    tcg_temp_free_i32(ctx->uc->tcg_ctx, t0);
}
#endif
...
static void spr_read_40x_pit (void *opaque, int gprn, int sprn)
{
    ...
    gen_helper_load_40x_pit(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env);
}
...
static void spr_read_403_pbr (void *opaque, int gprn, int sprn)
{
    ...
    tcg_gen_ld_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], cpu_env, offsetof(CPUPPCState, pb[sprn - SPR_403_PBL1]));
}
...
static void spr_write_403_pbr (void *opaque, int sprn, int gprn)
{
    ...
    TCGv_i32 t0 = tcg_const_i32(ctx->uc->tcg_ctx, sprn - SPR_403_PBL1);
...
static void spr_read_uamr (void *opaque, int gprn, int sprn)
{
    ...
    gen_load_spr(ctx->uc->tcg_ctx, cpu_gpr[gprn], SPR_AMR);
...
static void spr_write_uamr (void *opaque, int sprn, int gprn)
{
    ...
    gen_store_spr(ctx, SPR_AMR, cpu_gpr[gprn]);
...
static void spr_write_uamr_pr (void *opaque, int sprn, int gprn)
{
    ...
    gen_load_spr(ctx->uc->tcg_ctx, t0, SPR_UAMOR);
    tcg_gen_and_tl(ctx->uc->tcg_ctx, t0, t0, cpu_gpr[gprn]);
    gen_store_spr(ctx, SPR_AMR, t0);
    spr_store_dump_spr(SPR_AMR);
}
                                    ...
                                    int sprn, int cause)
{
    ...
    TCGv_i32 t1 = tcg_const_i32(ctx->uc->tcg_ctx, bit);
    TCGv_i32 t2 = tcg_const_i32(ctx->uc->tcg_ctx, sprn);
    TCGv_i32 t3 = tcg_const_i32(ctx->uc->tcg_ctx, cause);

    gen_update_current_nip(opaque);
    gen_helper_fscr_facility_check(ctx->uc->tcg_ctx, cpu_env, t1, t2, t3);
                                   ...
                                   int sprn, int cause)
{
    ...
    gen_update_current_nip(opaque);
    gen_helper_msr_facility_check(ctx->uc->tcg_ctx, cpu_env, t1, t2, t3);
...
static void spr_read_prev_upper32(void *opaque, int gprn, int sprn)
{
    ...
    TCGv spr_up = tcg_temp_new(ctx->uc->tcg_ctx);
    TCGv spr = tcg_temp_new(ctx->uc->tcg_ctx);

    gen_load_spr(ctx, spr, sprn - 1);
    tcg_gen_shri_tl(ctx->uc->tcg_ctx, spr_up, spr, 32);
    tcg_gen_ext32u_tl(ctx->uc->tcg_ctx, cpu_gpr[gprn], spr_up);

    tcg_temp_free(ctx->uc->tcg_ctx, spr);
    tcg_temp_free(ctx->uc->tcg_ctx, spr_up);
}
...
static void spr_write_prev_upper32(void *opaque, int sprn, int gprn)
{
    ...
    gen_load_spr(ctx, spr, sprn - 1);
    tcg_gen_deposit_tl(ctx->uc->tcg_ctx, spr, spr, cpu_gpr[gprn], 32, 32);
    gen_store_spr(ctx, sprn - 1, spr);
                               ...
                               void *opaque, const char *name, Error **errp)
{
    ...
    uint32_t *max_compat = qdev_get_prop_ptr(DEVICE(uc, obj), prop);
...
static void powerpc_set_compat(struct uc_struct *uc, Object *obj, Visitor *v,
                               void *opaque, const char *name, Error **errp)
{
    Error *error = NULL;
    char *value = NULL;
...
PowerPCCPUClass *ppc_cpu_class_by_pvr(struct uc_struct *uc, uint32_t pvr)
{
    ...
    list = object_class_get_list(uc, TYPE_POWERPC_CPU, false);
    item = g_slist_find_custom(list, &pvr, ppc_cpu_compare_class_pvr);
    if (item != NULL) {
        pcc = POWERPC_CPU_CLASS(uc, item->data);
    }
    g_slist_free(list);
...
PowerPCCPUClass *ppc_cpu_class_by_pvr_mask(struct uc_struct *uc, uint32_t pvr)
{
    ...
    list = object_class_get_list(uc, TYPE_POWERPC_CPU, true);
...
static gint ppc_cpu_compare_class_name(struct uc_struct *uc, gconstpointer a, gconstpointer b)
{
    ObjectClass *oc = (ObjectClass *)a;
    const char *name = b;
    PowerPCCPUClass *pcc = POWERPC_CPU_CLASS(uc, oc);
...
static ObjectClass *ppc_cpu_class_by_alias(struct uc_struct *uc, PowerPCCPUAlias *alias)
{
    ObjectClass *invalid_class = (void*)ppc_cpu_class_by_alias;

    /* Cache target class lookups in the alias table */
    if (!alias->oc) {
        alias->oc = ppc_cpu_class_by_name(uc, alias->model);
        if (!alias->oc) {
...
static GSList *g_slist_find_custom_uc (struct uc_struct *uc, GSList *list, gconstpointer data, GCompareFunc_uc func)
{
	if (!func)
		return NULL;
	
	while (list) {
		if (func (uc, list->data, data) == 0)
			return list;
...
static ObjectClass *ppc_cpu_class_by_name(struct uc_struct *uc, const char *name)
{
    ...
    check_pvr:
        ...
        if (i == 8) {
            ret = OBJECT_CLASS(ppc_cpu_class_by_pvr(uc, strtoul(name, NULL, 16)));
            return ret;
        }
    }

    list = object_class_get_list(uc, TYPE_POWERPC_CPU, false);
    item = g_slist_find_custom_uc(uc, list, name, ppc_cpu_compare_class_name);
    if (item != NULL) {
    ...
    for (i = 0; ppc_cpu_aliases[i].alias != NULL; i++) {
        if (strcmp(ppc_cpu_aliases[i].alias, name) == 0) {
            return ppc_cpu_class_by_alias(uc, &ppc_cpu_aliases[i]);
        }
    }
...
/*static gint ppc_cpu_list_compare(struct uc_struct *uc, gconstpointer a, gconstpointer b)
{
    ...
    PowerPCCPUClass *pcc_a = POWERPC_CPU_CLASS(uc, oc_a);
    PowerPCCPUClass *pcc_b = POWERPC_CPU_CLASS(uc, oc_b);
...
void ppc_cpu_list(struct uc_struct *uc, FILE *f, fprintf_function cpu_fprintf)
{
/*    CPUListState s = {
        .file = f,
    ...
    g_slist_foreach(uc, list, ppc_cpu_list_entry, &s);
    g_slist_free(list);
...
/*static void ppc_cpu_defs_entry(struct uc_struct *uc, gpointer data, gpointer user_data)
{
    ObjectClass *oc = data;
...
CpuDefinitionInfoList *arch_query_cpu_definitions(struct uc_struct *uc, Error **errp)
{
...
void ppc_cpu_register_types(void *opaque)
{
    ...
    ppc_cpu_type_info.name = TYPE_POWERPC_CPU,
    ppc_cpu_type_info.parent = TYPE_CPU,
    ppc_cpu_type_info.instance_userdata = opaque,
    ppc_cpu_type_info.instance_size = sizeof(PowerPCCPU),
    ppc_cpu_type_info.instance_init = ppc_cpu_initfn,
//    ppc_cpu_type_info.instance_post_init = arm_cpu_post_init,
 //   ppc_cpu_type_info.instance_finalize = arm_cpu_finalizefn,
    ppc_cpu_type_info.abstract = true,
    ppc_cpu_type_info.class_size = sizeof(PowerPCCPUClass),
    ppc_cpu_type_info.class_init = ppc_cpu_class_init,


    type_register_static((struct uc_struct *) opaque, &ppc_cpu_type_info);
